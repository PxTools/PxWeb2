import { ApiError, OutputFormatParamType, OutputFormatType, TableService, VariablesSelection } from '@pxweb2/pxweb2-api-client';

  export async function exportToFile(tabId: string, lang: string, variablesSelection: VariablesSelection, fileFormat: string): Promise<void> {
    ...
    switch (fileFormat) {
      ...
      case 'csv':
        ...
        outputFormatParams = [OutputFormatParamType.SEPARATOR_SEMICOLON, OutputFormatParamType.INCLUDE_TITLE];
