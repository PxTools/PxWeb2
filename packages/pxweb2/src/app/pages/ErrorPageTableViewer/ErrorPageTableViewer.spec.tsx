...
import { ErrorPageTableViewer } from './ErrorPageTableViewer';
...
describe('ErrorPageTableViewerTableViewer', () => {
  const mockError = {
    status: 404,
  ...
  it('renders without crashing', () => {
    const { baseElement } = renderWithProviders(<ErrorPageTableViewer />);

    expect(baseElement).toBeTruthy();
  });

  it('displays the error message', () => {
    const { getByText } = renderWithProviders(<ErrorPageTableViewer />);
