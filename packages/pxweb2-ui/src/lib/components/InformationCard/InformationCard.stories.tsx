...
export const Default: Story = {
  args: {
    ...
    icon: 'Book',
    children:<BodyLong  size="medium">This is an information card with heading.</BodyLong>,
  },
...
export const WithoutHeading: Story = {
  args: {
    icon: 'Book',
    children:<BodyLong  size="medium">This is an information card without heading.</BodyLong>,
  },
