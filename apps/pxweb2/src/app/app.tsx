  ...
  return (
    <>
      ...
      /> */}
          ...
          <br />
          <Select variant='inVariableBox' label='Select classification' secondLabel='Variable name' placeholder='Make selection' options={options} onChange={selectedOptionChanged}></Select>
          </div>
          <br />
