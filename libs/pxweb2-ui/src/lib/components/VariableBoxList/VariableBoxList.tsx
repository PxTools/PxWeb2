...
import classes from './VariableBoxList.module.scss';
...
export type VariableBoxListProps = {
...
export function VariableBoxList({
  pxTableMetadata,
  isLoadingMetadata,
...
}: VariableBoxListProps) {
  return (
    <div className={cl(classes.variableboxList)}>
      {!isLoadingMetadata &&
        hasLoadedDefaultSelection &&
        pxTableMetadata &&
...
export default VariableBoxList;
